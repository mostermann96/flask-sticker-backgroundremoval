...
from BE.app.api.auth.auth_logic import validation_error, AuthService

# Auth modules
from BE.app.api.auth.dto import AuthDto
from BE.app.api.auth.utils import LoginSchema, RegisterSchema
